...
import argparse
#from GLPanoDepth_LaucherConvNextTest import GLPanoDepth # 仅CNN
from ForTEST import DualProjectionFusionUp # 仅CNN
...
if __name__ == "__main__":
    ...
    # dataset
    parser.add_argument("--data_path", default="H:/GLPanoDepth_ConvNext_ViT_TFC_ANG_vitCUB2ERP_SUN360/", type=str, help="path to dataset")
    ...
    parser.add_argument("--batch_size", type=int, default=14, help="batch size") ## 非LUT 8
    parser.add_argument("--batch_size_test", type=int, default=1, help="batch size") ##
    parser.add_argument("--num_epochs", type=int, default=100, help="number of epochs")
    
    #system settings
    parser.add_argument("--num_workers", type=int, default=4, help="number of dataloader workers") ## 非LUT 6
    ...
    parser.add_argument("--log_dir", type=str, default="H:/GLPanoDepth_ConvNext_ViT_TFC_ANG_vitCUB2ERP_SUN360/experiments_Upright_LOG/", help="path to log")
