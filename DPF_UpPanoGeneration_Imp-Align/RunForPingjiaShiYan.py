...
import argparse
from ForTEST import DualProjectionFusionUp 
...
if __name__ == "__main__":
    ...
    # dataset
    parser.add_argument("--data_path", default="J:/pingjiashiyan4paper/SUN360/", type=str, help="path to dataset")
    ...
    parser.add_argument("--log_dir", type=str, default="J:/pingjiashiyan4paper/SUN360/experiments_Upright_LOG/", help="path to log")
